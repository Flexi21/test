...
##added by xen for import ProjectConfig.mk
export MTK_SHARED_SDCARD
export MTK_GMO_RAM_OPTIMIZE

export YK_BOARD_CONFIG
export YK_CUSTOMER_CONFIG
export YK_PLATFORM_CONFIG
export LCD_RESOLUTION
export CUSTOM_KERNEL_IMGSENSOR
export CUSTOM_KERNEL_MAIN2_IMGSENSOR
export CUSTOM_KERNEL_LENS
export CUSTOM_KERNEL_FLASHLIGHT
export CUSTOM_KERNEL_LCM
export BOOT_LOGO
export LCM_WIDTH
export LCM_HEIGHT
export CUSTOM_KERNEL_TOUCHPANEL
export CUSTOM_KERNEL_ACCELEROMETER
export YK_CUSTOM_KERNEL_ACCELEROMETER
export CUSTOM_KERNEL_ALSPS
export YK_CUSTOM_KERNEL_ALSPS
export CUSTOM_KERNEL_GYROSCOPE
export YK_CUSTOM_KERNEL_GYROSCOPE
export CUSTOM_KERNEL_MAGNETOMETER
export YK_CUSTOM_KERNEL_MAGNETOMETER
export CUSTOM_KERNEL_FINGERPRINT
export CUSTOM_KERNEL_TYPE_C_SUPPORT
export YK_EMMC_CAPACITY
export TOUCHPANEL_GESTURE
export ALSPS_GESTURE
export SINGLE_DIRECTION_GESTURE
export TOUCHPANEL_TOUCHFELL_IN_PHONE_CALL
export MTK_HOTKNOT_SUPPORT
export HALL_FUNCTION_SUPPORT
export MTK_LCM_PHYSICAL_ROTATION_HW
export CUSTOM_KERNEL_FASTCHARGING
export YK_AUDIO_PA_MODE
export YKQ_GPS_CLOCK
export YKQ_BATTERY_PROFILE_FROM_HEADER
export YKQ_LOW_TEMPERATURE_SHUTDOWN
export YKQ_USB_OTG_SUPPORT
export MTK_LCM_PHYSICAL_ROTATION_HW
export YKQ_DUAL_SPEAKER_SUPPORT
export YKQ_BREATH_LED_SUPPORT
export YKQ_CAM_SUB_LENS_SUPPORT
export YKQ_POWERKEY_LONGPRESS_SHUTDOWN
export YKQ_SPECIAL_FLASH_MEM_TEST
export YKQ_SPECIAL_FLASH_MEM_TEST_ZWL
export YKQ_DOUJIA_TEE_SUPPORT
export MICROARRY_TEE_SUPPORT
