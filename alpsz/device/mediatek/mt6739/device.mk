...
##added by xen for msensor 20180129
ifeq ($(CUSTOM_KERNEL_MAGNETOMETER), yes)
 ifeq ($(YK_CUSTOM_KERNEL_MAGNETOMETER), st480)
  ifeq ($(MTK_K64_SUPPORT), yes)
PRODUCT_COPY_FILES+=vendor/mediatek/libs/st480/libst480_64bit.so:vendor/lib64/libst480.so
  else
PRODUCT_COPY_FILES+=vendor/mediatek/libs/st480/libst480_32bit.so:vendor/lib/libst480.so
  endif
 endif

 ifeq ($(YK_CUSTOM_KERNEL_MAGNETOMETER), afx133)
  ifeq ($(MTK_K64_SUPPORT), yes)
PRODUCT_COPY_FILES+=vendor/mediatek/libs/afx133/lib64/libvtclib.so:vendor/lib64/libvtclib.so
  else
PRODUCT_COPY_FILES+=vendor/mediatek/libs/afx133/lib32/libvtclib.so:vendor/lib/libvtclib.so
  endif
 endif
endif
##added by xen for ST480 msensor 20180129
...
ifeq ($(strip $(HX_REMOVE_GOOGLE_VIDEO)), no)
...
##modified by xen for thermal policy:70" battemp system reset
ifeq ($(YKQ_BATTEMP70_THERMAL_SUPPORT),yes)
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/battemp70/thermal.eng.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
else
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/battemp70/thermal.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
endif
else
ifeq ($(TARGET_BUILD_VARIANT),eng)
...
##added by xen for DOUJIA-TEE 20180427
ifeq ($(strip $(YKQ_DOUJIA_TEE_SUPPORT)), yes)
ifeq ($(strip $(YKQ_DOUJIA_TEEI_SOURCE)), )
...
PRODUCT_COPY_FILES += 	device/mediatek/mt6739/teei/$(YKQ_DOUJIA_TEEI_SOURCE)/uTAgent:$(TARGET_COPY_OUT_VENDOR)/thh/uTAgent:mtk
PRODUCT_COPY_FILES += 	device/mediatek/mt6739/teei/$(YKQ_DOUJIA_TEEI_SOURCE)/init_thh:$(TARGET_COPY_OUT_VENDOR)/bin/init_thh:mtk
PRODUCT_COPY_FILES += 	device/mediatek/mt6739/teei/$(YKQ_DOUJIA_TEEI_SOURCE)/soter.raw:$(TARGET_COPY_OUT_VENDOR)/thh/soter.raw:mtk
endif
else
PRODUCT_COPY_FILES += 	vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6739/teei/soter.raw:$(TARGET_COPY_OUT_VENDOR)/thh/soter.raw:mtk
endif
...
#####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
###CUSTOMIZED BELOW:
## FingerPrint Begin: added by xen 20180126
##by xen start for fingperprint
ifneq ($(strip $(CUSTOM_KERNEL_FINGERPRINT)),)
PRODUCT_COPY_FILES += \
    frameworks/native/data/etc/android.hardware.fingerprint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.fingerprint.xml
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service

##ICN7152L fingerprint:
ifneq ($(findstring icn7152l, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
 PRODUCT_PACKAGES += fpExtensionSvc2
 ifeq ($(MTK_K64_SUPPORT), yes)
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/lib64/hw/fpsensor_fingerprint.default.so:system/lib64/hw/fpsensor_fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/lib64/hw/fpsensor_module.default.so:system/lib64/hw/fpsensor_module.default.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib64/libfp_ext_svc2.so:system/lib64/libfp_ext_svc2.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib64/android.hidl.base@1.0.so:system/lib64/android.hidl.base@1.0.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib64/android.hardware.fpsensorhidlsvc@2.0.so:system/lib64/android.hardware.fpsensorhidlsvc@2.0.so
 else
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/lib/hw/fpsensor_fingerprint.default.so:system/lib/hw/fpsensor_fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/lib/hw/fpsensor_module.default.so:system/lib/hw/fpsensor_module.default.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib/libfp_ext_svc2.so:system/lib/libfp_ext_svc2.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib/android.hidl.base@1.0.so:system/lib/android.hidl.base@1.0.so
   PRODUCT_COPY_FILES+=vendor/icn7152l/fpsensor_ree_lib/factory_lib/lib/android.hardware.fpsensorhidlsvc@2.0.so:system/lib/android.hardware.fpsensorhidlsvc@2.0.so  
 endif
endif

##ICN7152L fingerprint: FOR TEE
ifneq ($(findstring icnt7152_tee, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
  PRODUCT_PACKAGES += fpExtensionSvc2 
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
  PRODUCT_COPY_FILES += vendor/icnt7152_tee/fpsensor_tee_beanpod/ta_lib/fp_server:vendor/thh/fp_server 
  ...
  PRODUCT_COPY_FILES += vendor/icnt7152_tee/fpsensor_tee_beanpod/ca_lib/lib/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so
  PRODUCT_COPY_FILES += vendor/icnt7152_tee/fpsensor_tee_beanpod/factory_lib/lib/libfp_ext_svc2.so:vendor/lib/libfp_ext_svc2.so
  PRODUCT_COPY_FILES += vendor/icnt7152_tee/fpsensor_tee_beanpod/factory_lib/lib/vendor.fpsensor.hardware.fpsensorhidlsvc@2.0.so:vendor/lib/vendor.fpsensor.hardware.fpsensorhidlsvc@2.0.so
endif

##ICN7XXX fingerprint: FOR TEE
ifneq ($(findstring icn7xxx_tee, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
  PRODUCT_PACKAGES += fpExtensionSvc2 
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/ta_lib/fp_server:vendor/thh/fp_server 
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:vendor/etc/permissions/android.hardware.fingerprint.xml  
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/ca_lib/lib/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/factory_lib/lib/libfp_ext_svc2.so:vendor/lib/libfp_ext_svc2.so
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/factory_lib/lib/vendor.fpsensor.hardware.fpsensorhidlsvc@2.0.so:vendor/lib/vendor.fpsensor.hardware.fpsensorhidlsvc@2.0.so
ifeq ($(YKQ_FINGERPRINT_GESTURE_SUPPORT), yes) ##fingerprint gesture support is yes or not
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/ta_lib/fp_server_chipone:vendor/thh/fp_server_chipone
  PRODUCT_COPY_FILES += vendor/icn7xxx_tee/fpsensor_tee_beanpod/ca_lib/lib/hw/fpsensor_fingerprint.default.so:vendor/lib/hw/fpsensor_fingerprint.default.so
endif
endif

##CS2511 fingerprint:
ifneq ($(findstring cs2511, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
 PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1 CITTest
 ifeq ($(MTK_K64_SUPPORT), yes)
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/libcs_fp_binder.so:vendor/lib64/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/coating_alg/libCSAlgDll.so:vendor/lib64/libCSAlgDll.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/libfp_hal.so:vendor/lib64/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/chipsailing.fingerprint.default.so:vendor/lib64/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib64/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
 else
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/libcs_fp_binder.so:vendor/lib/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/coating_alg/libCSAlgDll.so:vendor/lib/libCSAlgDll.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/libfp_hal.so:vendor/lib/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/chipsailing.fingerprint.default.so:vendor/lib/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
 endif
 include vendor/chipsailing/ree/config/cs_cfg_1073_coating.mk
endif

##CS2511 fingerprint:
ifneq ($(findstring chipsailing2511_tee, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
 PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1 CITTest
 ifeq ($(MTK_K64_SUPPORT), yes)
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/libcs_fp_binder.so:vendor/lib64/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/coating/fp_server:vendor/thh/fp_server
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/libfp_tac.so:vendor/lib64/libfp_tac.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/libfp_hal.so:vendor/lib64/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/chipsailing.fingerprint.default.so:vendor/lib64/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib64/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/64-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
 else
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/libcs_fp_binder.so:vendor/lib/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/coating/fp_server:vendor/thh/fp_server_chipsailing
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/libfp_tac.so:vendor/lib/libfp_tac.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/libfp_hal.so:vendor/lib/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/chipsailing.fingerprint.default.so:vendor/lib/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/tee/32-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
 endif
 include vendor/chipsailing/tee/config/cs_cfg_1073_coating.mk
endif

##CS358 fingerprint:
ifneq ($(findstring cs358, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
 PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
 ifeq ($(MTK_K64_SUPPORT), yes)
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/libcs_fp_binder.so:vendor/lib64/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/glass_alg/libCSAlgDll.so:vendor/lib64/libCSAlgDll.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/libfp_hal.so:vendor/lib64/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/chipsailing.fingerprint.default.so:vendor/lib64/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib64/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/64-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
   ...
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/libcs_fp_binder.so:vendor/lib/libcs_fp_binder.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/glass_alg/libCSAlgDll.so:vendor/lib/libCSAlgDll.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/libfp_hal.so:vendor/lib/libfp_hal.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/chipsailing.fingerprint.default.so:vendor/lib/hw/chipsailing.fingerprint.default.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/vendor.chipsailing.fingerprint@1.0.so:vendor/lib/vendor.chipsailing.fingerprint@1.0.so
   PRODUCT_COPY_FILES+=vendor/chipsailing/ree/32-bit/vendor.chipsailing.fingerprint@1.0-service:vendor/bin/hw/vendor.chipsailing.fingerprint@1.0-service
 endif
 include vendor/chipsailing/ree/config/cs_cfg_358_glass.mk
endif

#microarray
ifneq ($(findstring microarray, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
 PRODUCT_PACKAGES += MAFactoryTest_4.0
####for microarray tee start######
 ifeq ($(MICROARRY_TEE_SUPPORT), yes)
 ifeq ($(TRUSTKERNEL_TEE_SUPPORT),yes) ##for pingbo tee
  PRODUCT_COPY_FILES += vendor/microarray_tee/app/t6/edcf9395-3518-9067-614cafae2909775b.ta:vendor/app/t6/edcf9395-3518-9067-614cafae2909775b.ta
 endif
 ifeq ($(MTK_K64_SUPPORT), yes)
  PRODUCT_COPY_FILES += vendor/microarray_tee/lib64/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so 
  PRODUCT_COPY_FILES += vendor/microarray_tee/lib64/libfprint-x64.so:vendor/lib/libfprint-x64.so
  ...
  PRODUCT_COPY_FILES += vendor/microarray_tee/lib/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so 
  PRODUCT_COPY_FILES += vendor/microarray_tee/lib/libfprint-x32.so:vendor/lib/libfprint-x32.so
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
 endif
######for microarray tee end#####
 else
 ifeq ($(MTK_K64_SUPPORT), yes)
  PRODUCT_COPY_FILES += vendor/microarray/lib64/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so 
  PRODUCT_COPY_FILES += vendor/microarray/lib64/libfprint-x64.so:vendor/lib/libfprint-x64.so
  PRODUCT_COPY_FILES += vendor/microarray/lib64/libma-fpservice.so:vendor/lib/libma-fpservice.so
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
 else
  PRODUCT_COPY_FILES += vendor/microarray/lib/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so 
  PRODUCT_COPY_FILES += vendor/microarray/lib/libfprint-x32.so:vendor/lib/libfprint-x32.so
  PRODUCT_COPY_FILES += vendor/microarray/lib/libma-fpservice.so:vendor/lib/libma-fpservice.so
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
 endif
...
##Sunwavecrop
ifneq ($(findstring sunwavecorp, $(strip $(CUSTOM_KERNEL_FINGERPRINT))),)
  PRODUCT_COPY_FILES += vendor/sunwavecorp/bin/fpserver:vendor/bin/fpserver
  PRODUCT_PACKAGES += FpFactoryO_hidl
 ifeq ($(MTK_K64_SUPPORT), yes)
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib64/libfpClient_sw.so:vendor/lib/libfpClient_sw.so
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib64/vendor.sw.swfingerprint@1.0.so:vendor/lib/vendor.sw.swfingerprint@1.0.so
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/hw/sw_sensor.default.so:vendor/lib/hw/sw_sensor.default.so
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:vendor/etc/permissions/android.hardware.fingerprint.xml
 else
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/libfpClient_sw.so:vendor/lib/libfpClient_sw.so
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/libfpService_sw.so:vendor/lib/libfpService_sw.so
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/vendor.sw.swfingerprint@1.0.so:vendor/lib/vendor.sw.swfingerprint@1.0.so                   
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/hw/fingerprint.default.so:vendor/lib/hw/fingerprint.default.so 
  PRODUCT_COPY_FILES += vendor/sunwavecorp/lib/hw/sw_sensor.default.so:vendor/lib/hw/sw_sensor.default.so
  PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
  PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:vendor/etc/permissions/android.hardware.fingerprint.xml
 endif
...
###added by xen for driver info display 20160513
$(call inherit-product, packages/apps/DriverInfo/driver_info.mk)
